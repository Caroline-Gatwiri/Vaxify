package com.twish.vaxify.auth.view
...
import com.twish.vaxify.auth.state.SignUpState
import com.twish.vaxify.auth.viewmodel.SignUpViewModel
import com.twish.vaxify.databinding.FragmentSignUpBinding
...
class SignUpFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvLogIn.setOnClickListener {
            val action =
                R.id.action_signUpFragment_to_logInFragment //.action_signUpFragment_to_logInFragment
